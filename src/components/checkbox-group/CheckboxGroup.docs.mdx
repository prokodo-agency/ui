...
`CheckboxGroup` shares all tokens with `Checkbox`. See the [Checkbox docs](/docs/components/checkbox#design-tokens) for the full token list.
...
<Canvas>
  <Story of={CheckboxGroupStories.CardGroup} />
</Canvas>

### Success card

<Canvas>
  <Story of={CheckboxGroupStories.SuccessCard} />
</Canvas>
