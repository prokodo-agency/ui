...
Use `Card` to group related content — blog teasers, product listings, feature highlights, pricing tiers. Choose a `color` to convey visual hierarchy or interactivity.
...
| ------------------------------ | ------------------------- | ------------------------- |
| `--pk-card-bg`                 | `var(--pk-color-surface)` | Card background           |
| `--pk-card-panel-light-border` | `rgba(0, 0, 0, 0.08)`     | Light panel border colour |
