...
describe("Carousel.lazy", () => {
  it("creates lazy wrapper with name 'Carousel' and is always interactive", () => {
    const CarouselLazy = require("./Carousel.lazy").default
    render(<CarouselLazy slides={[]} />)
    const wrapper = screen.getByTestId("lazy-wrapper")
    expect(wrapper).toBeInTheDocument()
    expect(wrapper).toHaveAttribute("data-name", "Carousel")
