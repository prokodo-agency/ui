...
describe("Select.lazy", () => {
  it("creates lazy wrapper with name 'Select' and is always interactive", () => {
    const SelectLazy = require("./Select.lazy").default
    render(<SelectLazy id="test" items={[]} />)
    const wrapper = screen.getByTestId("lazy-wrapper")
    expect(wrapper).toBeInTheDocument()
    expect(wrapper).toHaveAttribute("data-name", "Select")
