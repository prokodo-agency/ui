...
describe("Drawer.lazy", () => {
  it("creates lazy wrapper with name 'Drawer' and is always interactive", () => {
    const DrawerLazy = require("./Drawer.lazy").default
    render(<DrawerLazy open={false} />)
    const wrapper = screen.getByTestId("lazy-wrapper")
    expect(wrapper).toBeInTheDocument()
    expect(wrapper).toHaveAttribute("data-name", "Drawer")
