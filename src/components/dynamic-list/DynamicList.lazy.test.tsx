...
describe("DynamicList.lazy", () => {
  it("creates lazy wrapper with name 'DynamicList'", () => {
    const DynamicListLazy = require("./DynamicList.lazy").default
    render(<DynamicListLazy />)
    const wrapper = screen.getByTestId("lazy-wrapper")
    expect(wrapper).toBeInTheDocument()
    expect(wrapper).toHaveAttribute("data-name", "DynamicList")
