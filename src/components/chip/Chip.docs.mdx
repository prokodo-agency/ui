...
| Token                | Purpose                                                            |
| -------------------- | ------------------------------------------------------------------ |
| `--pk-space-sm`      | Horizontal padding, icon gap                                       |
| `--pk-radius-pill`   | Pill border-radius                                                 |
| `--pk-color-brand`   | Primary fill / border / shadow                                     |
| `--pk-color-accent`  | Secondary fill / border / shadow                                   |
| `--pk-color-success` | Success fill / border / shadow                                     |
| `--pk-color-warning` | Warning fill / border / shadow                                     |
| `--pk-color-error`   | Error fill / border / shadow                                       |
| `--pk-color-fg`      | Adaptive base text color (white in dark mode) and `inherit` shadow |
| `--pk-color-border`  | Outlined variant border                                            |
| `--pk-timing-normal` | Hover transition duration (color + shadow)                         |
