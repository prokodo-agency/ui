...
describe("PostWidgetCarousel.lazy", () => {
  it("creates lazy wrapper with name 'PostWidgetCarousel'", () => {
    const PostWidgetCarouselLazy = require("./PostWidgetCarousel.lazy").default
    render(<PostWidgetCarouselLazy />)
    const wrapper = screen.getByTestId("lazy-wrapper")
    expect(wrapper).toBeInTheDocument()
    expect(wrapper).toHaveAttribute("data-name", "PostWidgetCarousel")
