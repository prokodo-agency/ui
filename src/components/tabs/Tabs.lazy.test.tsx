...
describe("Tabs.lazy", () => {
  it("creates lazy wrapper with name 'Tabs' and is always interactive", () => {
    const TabsLazy = require("./Tabs.lazy").default
    render(<TabsLazy tabs={[]} />)
    const wrapper = screen.getByTestId("lazy-wrapper")
    expect(wrapper).toBeInTheDocument()
    expect(wrapper).toHaveAttribute("data-name", "Tabs")
