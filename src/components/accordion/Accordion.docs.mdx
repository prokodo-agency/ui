...
- `color` propagates the design-system colour token to header borders
...
| ------------------------------ | ------------------------ | -------------------- |
| `--pk-accordion-radius`        | `var(--pk-radius-md)`    | Item corner radius   |
| `--pk-accordion-border`        | `var(--pk-color-border)` | Border colour        |
| `--pk-accordion-border-focus`  | `var(--pk-color-brand)`  | Focused border       |
| `--pk-accordion-shadow`        | `var(--pk-shadow-sm)`    | Box-shadow           |
