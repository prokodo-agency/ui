...
`Form` has no component-scoped custom properties. Field appearance is controlled by the individual field components (`Input`, `Select`, etc.) and their respective tokens.
