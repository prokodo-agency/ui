...
- `color` applies the design-system colour token
...
| Token                | Purpose                                                    |
| -------------------- | ---------------------------------------------------------- |
| `--pk-color-brand`   | Primary background fill                                    |
| `--pk-color-accent`  | Secondary background fill                                  |
| `--pk-color-success` | Success background fill                                    |
| `--pk-color-warning` | Warning background fill                                    |
| `--pk-color-error`   | Error background fill                                      |
| `--pk-color-fg`      | Fallback icon color for `color="inherit"` (dark mode safe) |
| `--pk-palette-white` | White avatar background                                    |
| `--pk-shadow-sm`     | Drop shadow (size `lg` and above)                          |
