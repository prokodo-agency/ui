...
| `--pk-rte-toolbar-bg` | `color-mix(…)`            | Toolbar background tint |
| `--pk-rte-accent`     | `var(--pk-color-brand)`   | Active element colour   |
| `--pk-rte-icon-color` | `var(--pk-color-fg)`      | Icon colour             |
| `--pk-rte-radius`     | `var(--pk-radius-md)`     | Border radius           |
