...
| `--pk-carousel-dot-active-bg`  | `var(--pk-color-surface)`                                         | Füllung des aktiven Pagination-Punktes                                     |
| `--pk-carousel-button-padding` | `var(--pk-space-xs)`                                              | Innenabstand der Vor-/Zurück-Schaltflächen                                 |
| `--pk-carousel-dots-mt`        | `var(--pk-space-2xl)`                                             | Oberer Abstand über der Punkt-Indikator-Reihe                              |
