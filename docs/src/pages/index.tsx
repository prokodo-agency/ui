...
const COMPONENTS: ComponentItem[] = [
  ...
  },
  {
    ...
    category: "form",
    icon: "CheckListIcon",
    hoverIcon: "CheckmarkBadge01Icon",
  },
  {
    slug: "switch",
    label: "Switch",
  ...
  },
  {
    ...
    hoverIcon: "TextVariableFrontIcon",
  },
  {
    slug: "lottie",
    label: "Lottie",
  ...
  },
  {
    ...
    category: "display",
    icon: "Layers01Icon",
    hoverIcon: "ImageCompositionOvalIcon",
  },
  // ── Navigation ────────────────────────────────────────────────────────
  {
    slug: "accordion",
  ...
  },
  {
    ...
    hoverIcon: "CarouselVerticalIcon",
  },
  {
    slug: "stepper",
    label: "Stepper",
  ...
  },
  {
    ...
    hoverIcon: "NotificationBubbleIcon",
  },
  {
    slug: "tooltip",
    label: "Tooltip",
    category: "feedback",
    icon: "CursorInfo01Icon",
    hoverIcon: "ChatDone01Icon",
  },
  {
    slug: "skeleton",
    label: "Skeleton",
  ...
  // ── Content ───────────────────────────────────────────────────────────
  {
    ...
    category: "content",
    icon: "ListViewIcon",
    hoverIcon: "ParagraphBulletsPoint01Icon",
  },
  {
    slug: "pagination",
    label: "Pagination",
  ...
  },
  {
    ...
    category: "content",
    icon: "GridTableIcon",
    hoverIcon: "LayoutTable01Icon",
  },
  {
    slug: "post-widget-carousel",
    label: "Post Widget Carousel",
    category: "content",
...
> = {
  form: {
    label: translate({
      id: "prokodo.homepage.category.form.label",
      message: "Form",
    }),
    icon: "FilterIcon",
  ...
  display: {
    label: translate({
      id: "prokodo.homepage.category.display.label",
      message: "Display",
    }),
    icon: "Layers01Icon",
  ...
  navigation: {
    label: translate({
      id: "prokodo.homepage.category.navigation.label",
      message: "Navigation",
    }),
    icon: "Menu01Icon",
  ...
  feedback: {
    label: translate({
      id: "prokodo.homepage.category.feedback.label",
      message: "Feedback",
    }),
    icon: "Notification01Icon",
  ...
  content: {
    label: translate({
      id: "prokodo.homepage.category.content.label",
      message: "Content",
    }),
    icon: "File01Icon",
  ...
  service: {
    label: translate({
      id: "prokodo.homepage.category.service.label",
      message: "Service",
    }),
    icon: "GlobeIcon",
  ...
  return [
    {
      ...
      title: translate({
        id: "prokodo.homepage.feature.ready.title",
        message: "Drop-in Ready",
      }),
...
function FeatureCard({
  ...
  href,
  featureIdx,
}: Feature & { featureIdx: number }): ReactNode {
  return (
      ...
      <div className="container">
        <h1 className={styles.heroTitle}>
          ...
          <span className={styles.heroSrOnly}>
            <Translate id="prokodo.homepage.hero.srOnly">
              prokodo UI React Component Library
            </Translate>
          </span>
          {" UI"}
        </h1>
        <p className={styles.heroTagline}>
          <Translate id="prokodo.homepage.hero.tagline">
            AIC-ready, high-performance React UI components for Next.js and Vite
            — built for fast Core Web Vitals and scalable product teams.
          </Translate>
        </p>
        <div className={styles.heroStats}>
          <span>
            <Translate id="prokodo.homepage.hero.stats.components">
              50+ production-ready components
            </Translate>
          </span>
          <span className={styles.heroStatsDot}>·</span>
          <span>
            <Translate id="prokodo.homepage.hero.stats.darkMode">
              AIC-ready architecture
            </Translate>
          </span>
          <span className={styles.heroStatsDot}>·</span>
          <span>
            <Translate id="prokodo.homepage.hero.stats.typescript">
              High performance
            </Translate>
          </span>
          <span className={styles.heroStatsDot}>·</span>
          <span>
            <Translate id="prokodo.homepage.hero.stats.accessible">
        ...
        <div className={styles.heroInstall}>
          ...
          <span className={styles.heroInstallAlts}>
            <Translate id="prokodo.homepage.hero.alsoAvailable">
              Also available via
            </Translate>{" "}
  ...
  return (
    <Layout
      title={translate({
        ...
        message:
          "prokodo UI — AIC-ready React Component Library for Next.js & Vite",
      })}
      description={translate({
            ...
            <div className={styles.componentsSectionHead}>
              ...
              >
                <Translate id="prokodo.homepage.components.heading">
                  50+ production-ready React UI components
                </Translate>
              </Headline>
              <p className={styles.sectionSubtitle}>
                <Translate id="prokodo.homepage.components.subtitle">
                  Explore prokodo's UI component documentation with
                  implementation guidance, API references, and production-ready
                  usage examples.
                </Translate>
              </p>
            </div>
          ...
          <div className="container">
            ...
            <p className={styles.sectionSubtitle}>
              <Translate id="prokodo.homepage.features.subtitle">
                Built for modern product teams that need fast rendering,
                scalable architecture, and consistent UX across apps.
              </Translate>
            </p>
          ...
          <div className="container">
            ...
            <p className={styles.sectionSubtitle}>
              <Translate id="prokodo.homepage.quickstart.subtitle">
                Integrate an AIC-ready, high-performance component stack into
                your React app in just a few steps.
              </Translate>
            </p>
            <div className={styles.quickGrid}>
              <DocLink
                to="/docs/getting-started/installation"
                className={styles.codeStep}
              >
                <div className={styles.stepHeader}>
                  <span className={styles.stepNum}>1</span>
                  <span className={styles.stepLabel}>
                    <Translate id="prokodo.homepage.quickstart.step.install">
                      Install
                    </Translate>
                  </span>
                </div>
                <p className={styles.stepDesc}>
                  <Translate id="prokodo.homepage.quickstart.step.install.desc">
                    Add the library to your React project and start with
                    production-grade UI foundations.
                  </Translate>
                </p>
              ...
              >
                <div className={styles.stepHeader}>
                  ...
                  <span className={styles.stepLabel}>
                    <Translate id="prokodo.homepage.quickstart.step.theme">
                      Import theme
                    </Translate>
                  </span>
                </div>
                <p className={styles.stepDesc}>
                  <Translate id="prokodo.homepage.quickstart.step.theme.desc">
                    Enable token-driven theming for consistent light and dark
              ...
              <DocLink to="/docs/components/button" className={styles.codeStep}>
                <div className={styles.stepHeader}>
                  ...
                  <span className={styles.stepLabel}>
                    <Translate id="prokodo.homepage.quickstart.step.use">
                      Use
                    </Translate>
                  </span>
                </div>
                <p className={styles.stepDesc}>
                  <Translate id="prokodo.homepage.quickstart.step.use.desc">
                    Import typed, tree-shakable components optimized for
