...
| `onChange` | `(html: string) => void` | — | — | Called with serialised HTML on each change. |
| `label` | `string` | — | — | Editor label shown above the toolbar. |
| `placeholder` | `string` | — | — | Placeholder text shown in an empty editor. |
| `disabled` | `boolean` | `false` | — | Disable the editor. |
| `error` | `string` | — | — | Error message shown below the editor. |
