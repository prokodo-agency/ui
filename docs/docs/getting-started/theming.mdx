...
| File                           | Contents                                | Size    |
| ------------------------------ | --------------------------------------- | ------- |
| `@prokodo/ui/theme-tokens.css` | Design tokens only (`--pk-*` variables) | Small   |
| `@prokodo/ui/theme.css`        | Tokens **+ all component styles**       | ~288 KB |

For best performance, use `theme-tokens.css` and load component CSS per component (see [Installation](/docs/getting-started/installation)).
